...
if (token && !this.jwtHelper.isTokenExpired(token)) {
  ...
  register(name: string, email: string, password: string,phoneNumber:string,role:string,lastName:string): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/register`, { email, password, name,phoneNumber,role,lastName });
  }
